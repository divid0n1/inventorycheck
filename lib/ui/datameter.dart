...
class DataMeter extends StatefulWidget {
  final LocalFileSystem localFileSystem;

  DataMeter({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  _DataMeterState createState() => _DataMeterState();
}

class _DataMeterState extends State<DataMeter> {
  @override
  void initState() {
            ...
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(
                    fillColor: Colors.white.withOpacity(0.7),
                    filled: true,
                    hintText:  meterreadingNotifier.meterreadingList.isEmpty ? ' ' : '${meterreadingNotifier.meterreadingList.last.description}',
...
//                      height: MediaQuery.of(context).copyWith().size.height / 10,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText:  meterreadingNotifier.meterreadingList.isEmpty ? ' ' : '${meterreadingNotifier.meterreadingList.last.colour}',
                              fillColor: Colors.white.withOpacity(0.7),
                              filled: true,
                              border: UnderlineInputBorder(
                                  borderSide: new BorderSide(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    fillColor: Colors.white.withOpacity(0.7),
                    filled: true,
                    hintText:  meterreadingNotifier.meterreadingList.isEmpty ? ' ' : '${meterreadingNotifier.meterreadingList.last.condition}',                    border: UnderlineInputBorder(
                        borderSide:
                            new BorderSide(color: Color(0xff684c4c)))),
                validator: (String value) {
                  if (value.isEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    AudioMeterNotifier audioMeterNotifier = Provider.of<AudioMeterNotifier>(context);
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ImgGallery(jar: '7',)));
                            },
                            child: Stack(
                              children: <Widget>[
                                CircleAvatar(
                      ...
                      child: Stack(children: <Widget>[
                        ...
                        Container(
                          child: Positioned(
                            ...
                            top: 10,
                            child: Text(
                              '${audioMeterNotifier.audioMeterList.length ?? ''}',
...
//                      children: <Widget>[
//                        Text(meterreadingNotifier.meterreadingList[index].colour),
//                        Divider(
//                          thickness: 2,
//                          color: Colors.purple,
//                        ),
...
//                      ],
//                    ),
//                    itemCount: meterreadingNotifier.meterreadingList.length,
//                  ),
//                )
              ],
            ),
...
//                        print(images.length);
                ...
                child: Align(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      setState(() {
                        meterreadingNotifier.addMeterreading(Meterreading(_descriptiontx,
                            _quantitytxex, _colourtxex, _conditiontxex));
                      });
                      print(meterreadingNotifier.meterreadingList.length);
                      print(meterreadingNotifier.meterreadingList.first);
                      print(meterreadingNotifier.meterreadingList.last);
                    },
                    child: Container(
                      height: 40,
                      width: 40,
              ...
              Align(
                ...
                child: FloatingActionButton(
                  ...
                  backgroundColor: Color(0xff684c4c),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Tansuh(hasny: 'g',)));
...
//            new SnackBar(content: new Text("You must accept permissions")));
  ...
  Recstop() async {
    ...
    setState(() {
      ...
      audioMeterNotifier.addAudioMeter(AudioMeter(file));
