...
class DataHallway extends StatefulWidget {

  final LocalFileSystem localFileSystem;
  DataHallway({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  _DataHallwayState createState() => _DataHallwayState();
}

class _DataHallwayState extends State<DataHallway> {
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    AudioHallwayNotifier audioHallwayNotifier = Provider.of<AudioHallwayNotifier>(context);

    HallwayImgNotify hallwayImgNotify = Provider.of<HallwayImgNotify>(context);



//    var halldesc = hallwayNotifier.hallwayList.first.description.length ?? 'test';
//    var halldesc = '${}'  ? null ' ': '';
//if (3>4){4=a};
    var halldesc;
if (hallwayNotifier.hallwayList.isEmpty){
  halldesc = 'null';
    } else { halldesc = 'ddd';}
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(
                        width: 80,
                        child: InkWell(
                          onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => ImgGallery(jar: '2',)));
                    ...
                    child: Stack(
                      ...
                      Container(
                        child: Positioned(
                          ...
                          child:
                           Text(
                             '${audioHallwayNotifier.audioHallwayList.length ??''}',
                        ...
                        children: <Widget>[
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                fillColor: Colors.white.withOpacity(0.7),
                                filled: true,
                                hintText: hallwayNotifier.hallwayList.isEmpty ? ' ' : '${hallwayNotifier.hallwayList.last.description}',
...
//                      height: MediaQuery.of(context).copyWith().size.height / 10,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    TextFormField(
                                      decoration: InputDecoration(
                                        hintText:  hallwayNotifier.hallwayList.isEmpty ? ' ' : '${hallwayNotifier.hallwayList.last.quantity}',
                                          fillColor: Colors.white.withOpacity(0.7),
                                          filled: true,
                                          border: UnderlineInputBorder(
                                              borderSide: new BorderSide(
...
//                      height: MediaQuery.of(context).copyWith().size.height / 10,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    TextFormField(
                                      decoration: InputDecoration(
                                        hintText:  hallwayNotifier.hallwayList.isEmpty ? ' ' : '${hallwayNotifier.hallwayList.last.colour}',
                                          fillColor: Colors.white.withOpacity(0.7),
                                          filled: true,
                                          border: UnderlineInputBorder(
                                              borderSide: new BorderSide(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
//                              hintText: 'hellow',
                              hintText:  hallwayNotifier.hallwayList.isEmpty ? ' ' : '${hallwayNotifier.hallwayList.last.condition}',
                                fillColor: Colors.white.withOpacity(0.7),
                                filled: true,
//                                labelText: '',
                                border: UnderlineInputBorder(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    onTap: ()  {
                      ...
                      setState(() {
                        hallwayNotifier.addHallway(Hallway(_descriptiontx,_quantitytxex,_colourtxex,_conditiontxex));

                      });
                      print(hallwayNotifier.hallwayList.length);
                      print(hallwayNotifier.hallwayList.first);
                      print(hallwayNotifier.hallwayList.last);
                      print(hallwayNotifier.hallwayList);
                      },
                    child: Container(
                      height: 40,
                      width: 40,
  ...
  Recinit() async {
    try {
      if (await FlutterAudioRecorder.hasPermissions
        ...
        String customPath = '/inventory_audio_recorder_';
...
//            new SnackBar(content: new Text("You must accept permissions")));
  ...
  Recstop() async {
    ...
    setState(() {
      ...
      audioHallwayNotifier.addAudioHallway(AudioHallway(file));
