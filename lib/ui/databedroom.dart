...
class DataBedroom extends StatefulWidget {
  final LocalFileSystem localFileSystem;

  DataBedroom({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  _DataBedroomState createState() => _DataBedroomState();
}

class _DataBedroomState extends State<DataBedroom> {
  @override
  void initState() {
...
//                      height: MediaQuery.of(context).copyWith().size.height / 10,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText:  bedroomNotifier.bedroomList.isEmpty ? ' ' : '${bedroomNotifier.bedroomList.last.quantity}',
                              fillColor: Colors.white.withOpacity(0.7),
                              filled: true,
                              border: UnderlineInputBorder(
...
//                      height: MediaQuery.of(context).copyWith().size.height / 10,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText:  bedroomNotifier.bedroomList.isEmpty ? ' ' : '${bedroomNotifier.bedroomList.last.colour}',
                              fillColor: Colors.white.withOpacity(0.7),
                              filled: true,
                              border: UnderlineInputBorder(
                                  borderSide: new BorderSide(
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ImgGallery(jar: '5',)));
                          },
                            child: Stack(
                              children: <Widget>[
                                CircleAvatar(
                      ...
                      child: Stack(children: <Widget>[
                        ...
                        Container(
                          child: Positioned(
                            ...
                            top: 10,
                            child: Text(
                              '${audioBedroomNotifier.audioBedroomList.length ?? ''}',
                ...
                child: Align(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      setState(() {
                        bedroomNotifier.addBedroom(Bedroom(_descriptiontx,
                            _quantitytxex, _colourtxex, _conditiontxex));
                      });
                      print(bedroomNotifier.bedroomList.length);
                      print(bedroomNotifier.bedroomList.first);
                      print(bedroomNotifier.bedroomList.last);
                      print(bedroomNotifier.bedroomList);
                    },
                    child: Container(
                      height: 40,
                      width: 40,
...
//            new SnackBar(content: new Text("You must accept permissions")));
  ...
  Recstop() async {
    ...
    setState(() {
      ...
      audioBedroomNotifier.addAudioBedroom(AudioBedroom(file));
