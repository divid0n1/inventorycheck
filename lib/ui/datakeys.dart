...
class DataKeys extends StatefulWidget {
  ...
  DataKeys({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  _DataKeysState createState() => _DataKeysState();
}
          ...
          child: Column(
            children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText:  chaabiNotifier.chaabiList.isEmpty ? ' ' : '${chaabiNotifier.chaabiList.last.quantity}',
                              fillColor: Colors.white.withOpacity(0.7),
                              filled: true,
                              border: UnderlineInputBorder(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText:  chaabiNotifier.chaabiList.isEmpty ? ' ' : '${chaabiNotifier.chaabiList.last.colour}',
                              fillColor: Colors.white.withOpacity(0.7),
                              filled: true,
                              border: UnderlineInputBorder(
                                  borderSide: new BorderSide(
              ...
              TextFormField(
                ...
                maxLines: 4,
                decoration: InputDecoration(
                    hintText:  chaabiNotifier.chaabiList.isEmpty ? ' ' : '${chaabiNotifier.chaabiList.last.condition}',
                    fillColor: Colors.white.withOpacity(0.7),
                    filled: true,
                    border: UnderlineInputBorder(
                        borderSide:
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ImgGallery(jar: '6',)));
                            },
                            child: Stack(
                              children: <Widget>[
                                CircleAvatar(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      setState(() {
                        chaabiNotifier.addChaabi(Chaabi(_descriptiontx,
                            _quantitytxex, _colourtxex, _conditiontxex));
                      });
                      print(chaabiNotifier.chaabiList.length);
                      print(chaabiNotifier.chaabiList.first);
                      print(chaabiNotifier.chaabiList.last);
                      print(chaabiNotifier.chaabiList);
                    },
                    child: Container(
                      height: 40,
                      width: 40,
