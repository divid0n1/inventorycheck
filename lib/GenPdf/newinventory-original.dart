...
//      if(introNotifier.introList.isNotEmpty || introImgNotify.introImgList.isNotEmpty     ){content.add('Bedroom 2');}
//
//
//
...
//      if (extFrameNotifier.extFrameList.isNotEmpty || extFramePhNotifier.extFramePhList.isNotEmpty || extExdoorNotifier.extExdoorList.isNotEmpty ||
//          extExdoorPhNotifier.extExdoorPhList.isNotEmpty || extIndoorNotifier.extIndoorList.isNotEmpty || extIndoorPhNotifier.extIndoorPhList.isNotEmpty ||
//          extCeilingNotifier.extCeilingList.isNotEmpty || extCeilingPhNotifier.extCeilingPhList.isNotEmpty || extLightNotifier.extLightList.isNotEmpty ||
//          extLightPhNotifier.extLightPhList.isNotEmpty || extWallsNotifier.extWallsList.isNotEmpty || extWallsPhNotifier.extWallsPhList.isNotEmpty ||
//          extWindowsNotifier.extWindowsList.isNotEmpty || extWindowsPhNotifier.extWindowsPhList.isNotEmpty   ) { content.add('BEDROOM 2 '); }
//      if (smoFrameNotifier.smoFrameList.isNotEmpty || smoFramePhNotifier.smoFramePhList.isNotEmpty || smoExdoorNotifier.smoExdoorList.isNotEmpty ||
//          smoExdoorPhNotifier.smoExdoorPhList.isNotEmpty || smoIndoorNotifier.smoIndoorList.isNotEmpty || smoIndoorPhNotifier.smoIndoorPhList.isNotEmpty ||
//          smoCeilingNotifier.smoCeilingList.isNotEmpty || smoCeilingPhNotifier.smoCeilingPhList.isNotEmpty || smoLightNotifier.smoLightList.isNotEmpty ||
//          smoLightPhNotifier.smoLightPhList.isNotEmpty || smoWallsNotifier.smoWallsList.isNotEmpty || smoWallsPhNotifier.smoWallsPhList.isNotEmpty ||
//          smoWindowsNotifier.smoWindowsList.isNotEmpty || smoWindowsPhNotifier.smoWindowsPhList.isNotEmpty   ) { content.add('BEDROOM 3 '); }
//      if (bdfourFrameNotifier.bdfourFrameList.isNotEmpty || bdfourFramePhNotifier.bdfourFramePhList.isNotEmpty || bdfourExdoorNotifier.bdfourExdoorList.isNotEmpty ||
//          bdfourExdoorPhNotifier.bdfourExdoorPhList.isNotEmpty || bdfourIndoorNotifier.bdfourIndoorList.isNotEmpty || bdfourIndoorPhNotifier.bdfourIndoorPhList.isNotEmpty ||
//          bdfourCeilingNotifier.bdfourCeilingList.isNotEmpty || bdfourCeilingPhNotifier.bdfourCeilingPhList.isNotEmpty || bdfourLightNotifier.bdfourLightList.isNotEmpty ||
//          bdfourLightPhNotifier.bdfourLightPhList.isNotEmpty || bdfourWallsNotifier.bdfourWallsList.isNotEmpty || bdfourWallsPhNotifier.bdfourWallsPhList.isNotEmpty ||
//          bdfourWindowsNotifier.bdfourWindowsList.isNotEmpty || bdfourWindowsPhNotifier.bdfourWindowsPhList.isNotEmpty   ) { content.add('BEDROOM 4 '); }
//
...
//          itemBuilder:(_, int index){return pw.Row(children:<pw.Widget>[pw.Text(content[index],style:pw.TextStyle(fontSize:20,),textAlign: pw.TextAlign.left),pw.Text('  ',style:pw.TextStyle(fontSize:20,),textAlign: pw.TextAlign.left)]);})
//      ,]), ]),),),
//                              pw.SizedBox(
//                                height: 10,
//                              ),
...
//                          smoFramePhNotifier.smoFramePhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); } //ifelse
...
//                          smoExdoorPhNotifier.smoExdoorPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          smoIndoorPhNotifier.smoIndoorPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          smoCeilingPhNotifier.smoCeilingPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          smoLightPhNotifier.smoLightPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          smoWallsPhNotifier.smoWallsPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          smoWindowsPhNotifier.smoWindowsPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
//    }
//
//    writeOnPdfbd4() async {
...
//                          bdfourFramePhNotifier.bdfourFramePhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); } //ifelse
...
//                          bdfourExdoorPhNotifier.bdfourExdoorPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          bdfourIndoorPhNotifier.bdfourIndoorPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          bdfourCeilingPhNotifier.bdfourCeilingPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          bdfourLightPhNotifier.bdfourLightPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          bdfourWallsPhNotifier.bdfourWallsPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
...
//                          bdfourWindowsPhNotifier.bdfourWindowsPhList[n].photo.path).readAsBytesSync(),);return pw.Container(child: pw.Image(imag, height: 290,
//                          width: 400, fit: pw.BoxFit.cover)); }, ), ), ), ]), ), ), ])), ]), ]; }, )); }
//    }
//
//
